...
class CrescendoSwerveModuleState:
    corrected_motor_position: float
    turn_motor_position: float
...
class CrescendoSwerveModule:      #This is the 'constructor' which we refer to in the Drivtrain file i.e. CrescendoSwerveModule(3,4,5,ABSOLUTEPOS_4)                            #UPDATE: 2/3/2023
    ...
    def get_state(self):
        ...
        return CrescendoSwerveModuleState(corrected_motor_position, turn_motor_position)